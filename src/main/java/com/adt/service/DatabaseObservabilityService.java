...
public class DatabaseObservabilityService {
        ...
        private PoolMetricsDTO collectPoolMetrics() {
                ...
                int active = metrics != null ? metrics.activeCount() : 0;
                int available = metrics != null ? metrics.availableCount() : 0;
                int awaiting = metrics != null ? metrics.awaitingCount() : 0;
                int maxSize = agroal.getConfiguration().maxSize();
